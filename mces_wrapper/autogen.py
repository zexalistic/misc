...
class TypeDict:
    ...
    def load_enum_class_list(self):
        with open('enum_class.py') as fp:
            content = fp.read()
            self.enum_class_list = re.findall(r'class ([\w]+)[(]Enum[)]', content)
...
class HeaderParser:
    ...
    def parse(self):
        ...
        for h_file in self.h_files:
            with open(h_file) as fp:
                contents = fp.read()
                contents = re.sub(r'/\*.*\*/', '', contents)  # remove comments
                ...
                for content in contents:
                    ...
                    for param_info in param_infos:
                        ...
                        param = Param(param_info=param_info)
                    ...
                    # TODO: ret_type check in type dict
